                    ...
                    <div class="table-responsive">
                        ...
                        <form method="POST" action="{{route('bagian.update', $bagian['id'])}}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control text-uppercase" name="nama_bagian" id="nama_bagian" placeholder="nama_bagian" value="{{ $bagian->nama_bagian }}">
                            </div>
                            <div class="form-group">
                                <label for="keteranganBagian">keteranganBagian</label>
                                <textarea name="keteranganBagian" class="form-control" id="keteranganBagian" rows="3" placeholder="keteranganBagian">{{ $bagian->keteranganBagian }}</textarea>
                            </div>
