        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">{{ $ram['barang']['namaBarang'] }} ==> {{ $ram['barang']['kodeBarang'] }}</h6>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <form method="POST" action="" >
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="kapasitas" value="{{ $ram['tipeRam']['tipeRam'] }} " disabled>
                            </div>
