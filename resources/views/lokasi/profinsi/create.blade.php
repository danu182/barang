            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <form method="POST" action="{{route('profinsi.store')}}">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control text-uppercase" name="namaProfinsi" id="namaProfinsi" placeholder="nama Profinsi">
                            </div>

                            <div class="form-group">
                                <label for="keteranganProfinsi">keteranganProfinsi</label>
                                <textarea name="keteranganProfinsi" class="form-control" id="keteranganProfinsi" rows="3" placeholder="keterangan"></textarea>
                            </div>
