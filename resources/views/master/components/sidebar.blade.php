            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('kategori.index') }}">Category</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('tipe-mutasi.index') }}">tipe-mutasi</a>
                        <a class="collapse-item" href="{{ route('asset-mutasi.index') }}">mutasi asset</a>
                        <a class="collapse-item" href="{{ route('barang-mutasi.index') }}">barang-mutasi</a>
