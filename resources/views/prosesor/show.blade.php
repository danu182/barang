        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">{{ $prosesor['barang']['namaBarang'] }} ==> {{ $prosesor['barang']['kodeBarang'] }}</h6>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <form method="POST" action="" >
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="kapasitas" value="{{ $prosesor['tipeProsesor']['namaTipeProsesor'] }} " disabled>
                            </div>

                            <div class="form-group">
                                <label for="name">kapasitas</label>
                                <input type="text" class="form-control" name="kapasitas" value="{{ $prosesor['kapasitas'] }}" disabled>
                            </div>

                        <a href="{{ route('barang.prosesor.index',['barang'=>$prosesor['barang_id'], 'prosesor'=>$prosesor['id']]) }}" class="btn btn-success">kembali</a>
                        </form>
