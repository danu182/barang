            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <form method="POST" action="{{route('tipe-mutasi.store')}}">
                            @csrf

                            <div class="form-group">
                                <label for="exampleFormControlInput1">namaMutasi</label>
                                <input type="text" class="form-control text-uppercase" name="namaMutasi" id="namaMutasi" placeholder="namaMutasi">
                            </div>
                            <div class="form-group">
                                <label for="keteranganMutasi">keteranganMutasi</label>
                                <textarea name="keteranganMutasi" class="form-control" id="keteranganMutasi" rows="3" placeholder="keteranganMutasi"></textarea>
                            </div>
